...
alert("Please choose your gender");
    ...
    if(gender=="male" && calculate==0){
        alert("Your were born on "+days[0]+" and your Akan name is "+maleNames[0]);
        ...
        alert("Your were born on "+days[1]+" and your Akan name is "+maleNames[1]);
    } else if(gender=="female"&& calculate==1){
        alert("Your were born on "+days[1]+" and your Akan name is "+femaleNames[1]);
